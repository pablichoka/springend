...
-- AddForeignKey
ALTER TABLE "User_Role" ADD CONSTRAINT "fk_role" FOREIGN KEY ("role_id") REFERENCES "Roles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "Users" ADD CONSTRAINT "Users_assets_id_fkey" FOREIGN KEY ("assets_id") REFERENCES "Assets"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BM_Data" ADD CONSTRAINT "BM_Data_assets_id_fkey" FOREIGN KEY ("assets_id") REFERENCES "Assets"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
